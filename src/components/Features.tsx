...
import { Mic, Database, Brain, Scale, Users, Globe } from 'lucide-react';
...
export function Features() {
  ...
  const features = [
    ...
    },
    {
      ...
      titleUrdu: 'ویب سے دستیاب',
      description: 'Use Voice2Law from any device with a web browser — no app install required.',
