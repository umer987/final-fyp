      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-white/80">voice2law.fyp@gmail.com</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-[#1FAA59] mt-1 flex-shrink-0" />
                <div>
                  <p className="text-white/80">Mon–Sat, 9:00–18:00 (PKT)</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#1FAA59] mt-1 flex-shrink-0" />
                <div>
                  <p className="text-white/80">Department of FEST, Karachi, Pakistan</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="py-8 border-t border-white/10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-white/60 text-sm">
            <p>
              © 2026 Voice2Law. Final Year Project. All rights reserved.
            </p>
