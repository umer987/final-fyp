...
import { Code2, Server, Database, Mic, Brain, Shield } from 'lucide-react';
...
export function TechStack() {
  ...
  const technologies = [
    ...
    },
    {
      ...
      icon: Database,
      color: '#C5A253',
      tech: ['MongoDB', 'Chroma Vector DB', 'Mongoose']
    },
    {
      category: 'AI & NLP',
      icon: Brain,
    ...
    },
    {
      ...
      icon: Shield,
      color: '#C5A253',
      tech: ['REST API', 'JWT Auth', 'Google OAuth']
    }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-[#F8F9FA]">
      <div className="container mx-auto px-6">
        ...
        <div className={`mt-12 flex flex-wrap justify-center gap-4 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
          {['REST API', 'JWT Auth', 'Git', 'Postman'].map((badge, index) => (
            <div
              key={index}
