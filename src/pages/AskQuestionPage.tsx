...
const VoiceBot = lazy(() =>
  import('../components/VoiceBot').then((m) => ({ default: m.VoiceBot })),
);
const TextBot = lazy(() =>
  import('../components/TextBot').then((m) => ({ default: m.TextBot })),
);
import { Footer } from '../components/Footer';
import { NlpServiceBanner } from '../components/NlpServiceBanner';
