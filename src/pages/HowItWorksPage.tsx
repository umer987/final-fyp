  ...
  const securityFeatures = [
    {
      ...
      description: 'When you are signed in, your questions and answers are saved to your account in MongoDB so you can review them later. Guest sessions are not linked to a profile.'
    },
    {
      icon: Zap,
